            ...
            <article>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {project.technologies.map((tech: string, id: number) => (
                  <span
                    key={id}
                    className="text-xs px-3 py-1 bg-surface border border-outline rounded-full text-secondary hover:bg-primary hover:text-foreground transition-all ease-in"
                  >
                    {tech}
                  </span>
                ))}
